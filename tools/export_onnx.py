...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg_file', type=str, default='/home/willer/nanodet_concat/config/nanodet_custom_xml_dataset_helmet.yml', help='config file path')
    parser.add_argument('--weights_file', type=str, default='/home/willer/nanodet_concat/tools/models/model_best/model_best.pth', help='weights file path')
    parser.add_argument('--output_file', type=str, default='./nanodet-simple.onnx', help='onnx file path')
