...
class PAN(FPN):
    ...
    def __init__(self,
        ...
        self.init_weights()
        self.conv = nn.Conv2d(in_channels=96, out_channels=96, kernel_size=3, stride=2, padding=1)
        self.deconv = nn.ConvTranspose2d(in_channels=96, out_channels=96, kernel_size=2, stride=2)
    ...
    def forward(self, inputs):
        ...
        for i in range(used_backbone_levels - 1, 0, -1):
            ...
            laterals[i - 1] = laterals[i - 1] + self.deconv(laterals[i])
        ...
        for i in range(0, used_backbone_levels - 1):
            ...
            inter_outs[i + 1] = inter_outs[i + 1] + self.conv(inter_outs[i])
